...
export default function Home() {
  ...
  /**
   * Returns a Provider object representing the Ethereum RPC 
   *
   * A `Provider` is needed to interact with the blockchain - reading transactions, reading balances, reading and updating state, etc.
   *
   * 
   */
  const getProvider = async () => {
    ...
    console.log(await web3Provider.eth.net.getId());
  ...
  }, [walletConnected, tokenIdsMinted]);
  ...
  return (
    <div>
      <Head>
        <title>StepUpNFT</title>
        <meta name="description" content="StepUpNFT-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to StepUpNFT!</h1>
